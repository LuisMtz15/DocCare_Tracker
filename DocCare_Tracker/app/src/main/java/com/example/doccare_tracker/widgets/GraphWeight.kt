...
fun WeightScreen(
    ...
    Box(
        ...
        Surface(
            modifier = Modifier.fillMaxWidth().height(380.dp) // Ajuste de ancho y altura (en ese orden)
            ...
            if (valueMax != null) {
                if (valueMin != null) {
                    WeightGraph(
                        ...
                        modifier = Modifier.padding(bottom = 16.dp, start = 16.dp, end = 16.dp, top = 130.dp),
                        nombre_1=nombre1,
                        nombre_2=nombre2,
                        nombre_3= nombre3
                    )
