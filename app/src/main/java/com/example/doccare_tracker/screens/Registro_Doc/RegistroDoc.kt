...
@Composable
fun Registro_prin_doc(navController: NavHostController, viewModel: AppViewModel) {
                        ...
                        CustomButton(color = MyColorPalette.registros, colorText = Color.White,
                            ...
                            onClickAction = {
                                if (isPasswordokey.value){
                                    ...
                                    else{showDialog_perf.value = true}
            ...
            signupResult?.let { result ->
                LaunchedEffect(result) {
                    if (result.isSuccess) {
                        ...
                        viewModel.registrardetalleDoctor(usuario_id.value)
                        viewModel.setRegistrarUsuarioResult(result=null)
                        viewModel.setRegistrarDetalleDoctorResult(result=null)
